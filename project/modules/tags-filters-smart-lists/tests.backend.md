...
- `BE-UNIT-TF-001`: tag CRUD enforces stable slug identity and rejects duplicate slugs.
- `BE-UNIT-TF-002`: every built-in smart list resolves to the documented predicate.
...
- `BE-E2E-TF-001`: each smart list and saved filter resolves to a deterministic predicate that matches the documented sidebar counts and explanation text.
