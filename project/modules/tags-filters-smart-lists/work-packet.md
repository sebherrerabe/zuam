...
## Objective
Make taxonomy and saved-view behavior deterministic so the sidebar, filters, and smart lists all resolve to the same query language.

## Files / Packages Expected To Change
- Taxonomy domain docs.
- Sidebar and list-view contracts.
- Query predicate definitions.

## Contracts To Implement First
- Tag identity contract.
- Smart-list predicate contract.
- Saved-filter AST contract.

## Tests To Create First
- `BE-UNIT-TF-001`, `BE-UNIT-TF-002`, `BE-UNIT-TF-003`.
- `FE-UNIT-TF-001`, `FE-E2E-TF-001`.
