...
## Objective
Implement the first desktop escalation loop so overdue or postponed tasks can trigger level 1 notifications and level 2 blocking dialogs.
...
- The front-end modal can be built against mock nudge events before the scheduler is complete.
